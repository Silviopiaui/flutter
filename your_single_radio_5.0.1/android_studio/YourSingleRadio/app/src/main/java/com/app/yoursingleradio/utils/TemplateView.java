...
public class TemplateView extends FrameLayout {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.gnt_admob_template_view) {
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        try {
            templateType = attributes.getResourceId(R.styleable.TemplateView_gnt_template_type, R.layout.gnt_admob_template_view);
        } finally {
            attributes.recycle();
        }
